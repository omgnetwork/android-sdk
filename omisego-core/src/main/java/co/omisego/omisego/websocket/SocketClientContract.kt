...
interface SocketClientContract {
    ...
    interface Builder {
         ...
         */
        var clientConfiguration: CredentialConfiguration?
        ...
        /**
         * (Optional) The OKHttp interceptor list for debugging purpose.
         */
        var debugOkHttpInterceptors: MutableList<Interceptor>
    ...
    interface Client : SocketConnectionListenerSet, SocketChannelListenerSet, SocketCustomEventListenerSet {
         ...
         */
        fun setAuthenticationHeader(credentialConfiguration: CredentialConfiguration)
