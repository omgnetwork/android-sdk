...
internal class OMGAdapter<R>(private val responseType: Type, private val adapter: TypeAdapter<R>) : CallAdapter<OMGResponse<R>, OMGCall<OMGResponse<R>>> {
    override fun adapt(call: Call<OMGResponse<R>>): OMGCall<OMGResponse<R>> {
        return OMGCallAdapter(call)
    }
